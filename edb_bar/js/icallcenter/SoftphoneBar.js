...
hojo.declare("icallcenter.SoftphoneBar", null, {
	...
	_softphonebar_ivrMenuTransfering: function(json){
		console.log(json);
		if(json.Event == "IvrMenuEnd"){
			...
			if(json.VAL_OF_IVR_MENU){
				...
				if(outIvrRefused == "DTSF"){
					...
					console.log(outIvrRefused);
					icallcenter.hojotools.showSucc(outIvrRefused);
				}else{
					console.log(outIvrRefused);
					icallcenter.hojotools.showSucc(outIvrRefused);
				}
	...
	_softphonebar_transfering: function(json) {
